...
chrome_options_muktinath.add_argument("--window-size=0,0")  # Set window size as desired (800x600 in this example)
chrome_options_muktinath.add_argument("--window-position=0,1080")  # Set window position at the lower left corner (0, 1080 in this example)
